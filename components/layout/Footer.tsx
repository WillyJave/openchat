      ...
      <div className="py-16 border-b border-white/5">
        <div className="container text-center">
          ...
          <p className="text-muted mb-8 max-w-xl mx-auto">
            Únete a los más de 500 negocios que ya multiplicaron sus conversiones
            con OpenChat.
          </p>
        ...
        <div className="container">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted max-w-sm">
                ...
                Multiplica tus conversiones sin aumentar tu equipo.
              </p>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted">
              © {new Date().getFullYear()} OpenChat. Todos los derechos reservados.
            </p>
